...
how_many_iter = 1000 # liczba iteracji co ile będzie sprawdzane czy <E>=const.
...
E_mean_previous = math.nan #ostatnio liczona średnia liczba krawędzi
...
while True:
    ...
    if iteration % how_many_iter == 0:
        ...
        if E_mean_current == E_mean_previous:
            break
        else:
            E_mean_previous = E_mean_current
